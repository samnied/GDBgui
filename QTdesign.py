...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnRun.setGeometry(QtCore.QRect(40, 230, 93, 28))
        font = QtGui.QFont()
        ...
        self.textOutput.setGeometry(QtCore.QRect(40, 290, 411, 301))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.textOutput.setFont(font)
        self.textOutput.setObjectName("textOutput")
        self.stlinkOutput = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.stlinkOutput.setGeometry(QtCore.QRect(520, 310, 431, 87))
        self.stlinkOutput.setObjectName("stlinkOutput")
        self.label3 = QtWidgets.QLabel(self.centralwidget)
        self.label3.setGeometry(QtCore.QRect(520, 270, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label3.setFont(font)
        self.label3.setObjectName("label3")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(160, 230, 118, 23))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.label4 = QtWidgets.QLabel(self.centralwidget)
        self.label4.setGeometry(QtCore.QRect(520, 420, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label4.setFont(font)
        self.label4.setObjectName("label4")
        self.gdbOutput = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.gdbOutput.setGeometry(QtCore.QRect(520, 460, 431, 87))
        ...
        self.commentEdit.setGeometry(QtCore.QRect(170, 130, 371, 51))
